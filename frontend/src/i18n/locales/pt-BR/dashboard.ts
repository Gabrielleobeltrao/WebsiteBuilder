export default {
  ...
  sites: {
    ...
    card: {
      status: {
        live: "No ar",
        draft: "Rascunho",
        pending: "No ar, com alterações não publicadas",
        unverified: "No ar, sem verificação",
      ...
      pendingUnknown: "Não dá para mostrar — este site foi publicado antes do rastreamento de alterações",
      republish: "Publicar para verificar",
      ...
      blocker: {
        "no-address": "Publicado, mas ainda sem endereço apontando para ele",
        "blog-setup": "O blog está ativo, mas os layouts nunca foram publicados",
      },
      traffic: "Últimos {{days}} dias",
      views: "{{count}} visualizações",
      visitors: "{{count}} visitantes",
      visitorsUnavailable: "Visitantes não estão sendo medidos",
      trafficUnavailable: "Nada medido ainda — o site nunca foi publicado",
      edit: "Editar",
    },
    saving: "Salvando…",
  },
  ...
  "site": {
    ...
    "destinations": "Tudo neste site",
    "publicationUnknown": "Este site foi publicado antes de as alterações passarem a ser rastreadas, então não dá para mostrar se os visitantes têm o seu trabalho mais recente. Publique uma vez para descobrir.",
    "pendingPublication": "Você tem alterações salvas que os visitantes ainda não receberam.",
    "upToDate": "Os visitantes estão vendo sua última versão publicada.",
    "neverPublished": "Este site nunca foi publicado.",
    "startBlog": "Começar um blog",
    "startModuleCard": "Ainda não está em uso",
    "openModule": "Abrir",
    "destination": {
      "pages": "Páginas",
      "pagesHint": "Monte as páginas do site.",
      "blog": "Blog",
      "blogHint": "Posts, layouts e as configurações do blog.",
      "forms": "Formulários",
      "formsHint": "Formulários e as respostas que as pessoas enviam.",
      "cms": "CMS",
      "cmsHint": "Coleções estruturadas para listar em uma página.",
      "media": "Mídia",
      "mediaHint": "As imagens que este site usa.",
      "analytics": "Análises",
      "analyticsHint": "O que os visitantes fizeram, medido no seu próprio site.",
      "domains": "Domínios",
      "domainsHint": "Os endereços que apontam para este site."
    },
    "nav": {
      "blog": "Blog",
      "forms": "Formulários",

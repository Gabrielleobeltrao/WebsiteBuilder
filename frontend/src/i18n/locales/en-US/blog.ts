export default {
  ...
  posts: {
    ...
    status: { draft: "Draft", published: "Ready" },
    publishedOn: "Ready since {{when}}",
  ...
  editor: {
    ...
    conflict: "Somebody else saved this post while it was open. Your text is still here and nothing was lost \u2014 open the newer version before writing over it.",
    conflictReload: "Open the newer version",
    visibilityLabel: "Visibility",
    visibilityDraft: "Draft",
    visibilityPublished: "Published",
    visibilityDraftHint: "Only you can see it. The post does not appear on the site.",
    visibilityPublishedHint: "Appears on the site's blog at the site's next publication.",
    publishedOn: "Published on {{date}}",
    fieldImageChoose: "Choose an image for {{field}}",
    fieldNotEditable: "This field keeps the value it already has, but cannot be filled in here yet.",
    back: "Back to posts",
    newPost: "New post",

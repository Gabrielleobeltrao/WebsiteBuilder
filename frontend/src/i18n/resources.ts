...
export const resources = {
  "en-US": { common: enCommon, public: enPublic, dashboard: enDashboard, builder: enBuilder, auth: enAuth, blog: enBlog, errors: enErrors },
  "pt-BR": { common: ptCommon, public: ptPublic, dashboard: ptDashboard, builder: ptBuilder, auth: ptAuth, blog: ptBlog, errors: ptErrors },
} as const;

export const NAMESPACES = ["common", "public", "dashboard", "builder", "auth", "blog", "errors"] as const;

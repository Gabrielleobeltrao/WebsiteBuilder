...
export const resources = {
  "en-US": { common: enCommon, public: enPublic, dashboard: enDashboard, builder: enBuilder, errors: enErrors },
  "pt-BR": { common: ptCommon, public: ptPublic, dashboard: ptDashboard, builder: ptBuilder, errors: ptErrors },
} as const;

export const NAMESPACES = ["common", "public", "dashboard", "builder", "errors"] as const;

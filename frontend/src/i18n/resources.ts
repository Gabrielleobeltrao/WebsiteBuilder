...
export const resources = {
  "en-US": { common: enCommon, public: enPublic, dashboard: enDashboard, builder: enBuilder, auth: enAuth, errors: enErrors },
  "pt-BR": { common: ptCommon, public: ptPublic, dashboard: ptDashboard, builder: ptBuilder, auth: ptAuth, errors: ptErrors },
} as const;

export const NAMESPACES = ["common", "public", "dashboard", "builder", "auth", "errors"] as const;

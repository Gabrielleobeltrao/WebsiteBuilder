...
import enForms from "./locales/en-US/forms";
...
import ptForms from "./locales/pt-BR/forms";
...
export const resources = {
  "en-US": { common: enCommon, public: enPublic, dashboard: enDashboard, builder: enBuilder, auth: enAuth, blog: enBlog, cms: enCms, publishing: enPublishing, readiness: enReadiness, analytics: enAnalytics, forms: enForms, errors: enErrors },
  "pt-BR": { common: ptCommon, public: ptPublic, dashboard: ptDashboard, builder: ptBuilder, auth: ptAuth, blog: ptBlog, cms: ptCms, publishing: ptPublishing, readiness: ptReadiness, analytics: ptAnalytics, forms: ptForms, errors: ptErrors },
} as const;

export const NAMESPACES = ["common", "public", "dashboard", "builder", "auth", "blog", "cms", "publishing", "readiness", "analytics", "forms", "errors"] as const;

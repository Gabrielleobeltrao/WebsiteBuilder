...
- 2026-08-12 — **Next**: 5.2 (form binding to the module: API, conditional destination, publish gating), Phase 6 (patterns), 7.2/7.5 (per-block runtime capabilities already declared; parity snapshots), 8, 9, 10.

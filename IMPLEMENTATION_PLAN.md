...
- [ ] **3.2 Image.** Integrate the media library picker, focal point/object fit, responsive sizing, link, lazy/eager priority, alt/decorative choice, caption, and intrinsic dimensions.
- [ ] **3.3 Button.** Render leading/trailing icons, typed links, target behavior, accessible label, loading-safe states, hover/focus/active styles, width/alignment, and responsive sizing.
